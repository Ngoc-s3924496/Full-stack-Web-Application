...
<body>
    <img src="<?php $dir = '../../UserData/ProfileImages/'; echo get_profile_img($_SESSION['email_user_detail'], $_SESSION['fname_user_detail'], $_SESSION['lname_user_detail'], $dir);?>" alt="User's profile image">
